...
*/
class Statistics_Tool : public QWidget
{
  ...
  public:
    ...
    */
    ...
    static const double DEFAULT_OPACITY[3];

    /*==============================================================================
        Constructors
    */
    Statistics_Tool(const QString &title, QWidget *parent = NULL, Qt::WindowFlags flags = Qt::Widget);
  ...
  protected:
    ...
    unsigned int Display_to_Stats_Map[3];
    ...
    QWidget *Graph_Panel;
    QSpinBox *Count_Scale_Max;
    QwtPlot *Graph;
    Histogram_Plot *Plot[3];
  ...
  private:
    QLabel *Origin[2], *Size[2], *Sampled_Area, *Area, *Band_Names[3], *Values[3], *Below_Limit_Label, *Below_Limit[3],
        *Lowest_Value[3], *Highest_Value[3], *Above_Limit_Label, *Above_Limit[3], *Minimum_Count[3], *Maximum_Count[3],
        *Mean_Value[3], *Median_Value[3], *Std_Dev_of_Values[3];

    QSpinBox *Lower_Limit, *Upper_Limit, *Opacity[3];
};
