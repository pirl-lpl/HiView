...
using
UA::HiRISE::HiView_Application,
UA::HiRISE::HiView_Window,
UA::HiRISE::HiView_Utilities;
        ...
        if (arg_list[count][0] == '-')
        {
            switch (toupper(arg_list[count][1]))
            {
                    ...
                    else
                    {
                            ...
                            .compare("-STYLES", Qt::CaseInsensitive) == 0)
                        {
                            ...
                            for (int
                                 ...
                                 index < styles.size();
                                 index++)
                                cout << " " << styles.at(index).toStdString() << endl;
                            exit(SUCCESS);
                        }
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    if (style.compare(arg_list[count], Qt::CaseInsensitive) == 0)
                                    {
                            ...
                            cout << "Unrecognized style name '" << arg_list[count] << "'" << endl
                                << endl;
                            usage();
                        }
                    }
                ...
                case 'F': // -Formats
                    ...
                    {
                        cout << QString(entry).toStdString() << ' ';
                    }
                    cout << endl;
