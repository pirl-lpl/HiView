...
class Metadata_Dialog : public QDialog
{
  ...
  public:
    ...
    */
    explicit Metadata_Dialog(idaeim::PVL::Aggregate *parameters, QWidget *parent = NULL,
  ...
  public slots:
    ...
    */
    bool save_metadata(idaeim::PVL::Parameter *metadata = NULL, const QString &title = QString());
  ...
  private slots:
    ...
    */
    void selection_changed(const QItemSelection &current, const QItemSelection &previous);
  ...
  public:
    ...
    */
    static bool save(const idaeim::PVL::Parameter *const parameters, const QString &pathname);
