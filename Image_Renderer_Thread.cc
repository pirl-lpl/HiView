...
/*==============================================================================
 Constructors
*/
Image_Renderer_Thread::Image_Renderer_Thread(QObject* parent) : Image_Renderer(parent)
{
...
Image_Renderer_Thread::run()
{
    ...
    LOCKED_LOGGING((
        clog << ">>> Image_Renderer_Thread::run " << reinterpret_cast<void*>(this) << endl));
#endif
    Runnable = true;
    Suspended = false;
    Finish = false;
...
#if ((DEBUG_SECTION) & DEBUG_RENDER)
    LOCKED_LOGGING((
        clog << "<<< Image_Renderer_Thread::run: exiting thread " << reinterpret_cast<void*>(this) << endl));
#endif
}
...
Image_Renderer_Thread::is_ready()
{
    ...
    LOCKED_LOGGING((
        clog << ">>> Image_Renderer_Thread::is_ready " << reinterpret_cast<void*>(this) << endl
        << "    in " << pathname << endl
        << ">>> Image_Renderer_Thread::is_ready "
    ...
    if (Suspended)
    {
        ...
        LOCKED_LOGGING((
            clog << "^^^ Image_Renderer_Thread::is_ready " << reinterpret_cast<void*>(this)
...
#if ((DEBUG_SECTION) & DEBUG_RENDER)
        LOCKED_LOGGING((
            clog << "xxx Image_Renderer_Thread::is_ready " << reinterpret_cast<void*>(this)
    ...
    LOCKED_LOGGING((
        ...
        << "<<< Image_Renderer_Thread::is_ready " << reinterpret_cast<void*>(this)
...
Image_Renderer_Thread::start_rendering()
{
...
#if ((DEBUG_SECTION) & DEBUG_RENDER)
    LOCKED_LOGGING((
        clog << ">>> Image_Renderer_Thread::start_rendering " << reinterpret_cast<void*>(this) << endl
        << "    in " << pathname << endl));
#endif
    /*if (isRunning ())
    {
    ...
    LOCKED_LOGGING((
        clog << "    in " << pathname << endl
        << "<<< Image_Renderer_Thread::start_rendering " << reinterpret_cast<void*>(this) << endl));
#endif
}
...
)
{
    ...
    QString
        pathname(object_pathname(static_cast<Image_Renderer*>(this)));
    LOCKED_LOGGING((
        clog << ">>> Image_Renderer_Thread::suspend_rendering " << reinterpret_cast<void*>(this)
        << ": wait = " << boolalpha << wait << endl
        << "    in " << pathname << endl));
#endif
    bool done = Image_Renderer::suspend_rendering(wait);

#if ((DEBUG_SECTION) & DEBUG_RENDER)
    LOCKED_LOGGING((
        clog << "    in " << pathname << endl
        << "<<< Image_Renderer_Thread::suspend_rendering " << reinterpret_cast<void*>(this)
        << ": " << boolalpha << done << endl));
#endif
    return done;
}
...
)
{
    ...
    LOCKED_LOGGING((
        clog << ">>> Image_Renderer_Thread::finish " << reinterpret_cast<void*>(this)
...
#if ((DEBUG_SECTION) & (DEBUG_CONSTRUCTORS | DEBUG_RENDER))
    LOCKED_LOGGING((
        clog << "<<< Image_Renderer_Thread::finish " << reinterpret_cast<void*>(this) << endl));
#endif
