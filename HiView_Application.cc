    ...
    : QApplication(argc, argv)
{
    ...
    */
    ...
    //installEventFilter(new NullEventFilter());
    ...
    QEvent* event)
{
    if (event->type() == QEvent::FileOpen)
    {
        ...
        if (HiView_Utilities::is_jpip_passthru_link(Requested_Pathname))
        {
            QString Requested_Link = HiView_Utilities::parse_jpip_passthru_link(Requested_Pathname);
