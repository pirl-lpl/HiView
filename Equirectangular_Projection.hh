...
class Equirectangular_Projection : public Projection
{
  public:
    ...
    */
    explicit Equirectangular_Projection(const idaeim::PVL::Aggregate *parameters = 0);
    ...
    */
    virtual Equirectangular_Projection &operator=(const Equirectangular_Projection &projection);
  ...
  protected:
    //	Pre-computed values.
    double Local_Radius, Local_Radius_Coefficient;
