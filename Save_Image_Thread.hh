...
public:
	...
	*/
	/*	Specify the image and the file pathname and image file format to
		...
		@param	plastic_image	A pointer to the Dynamic_Image to be saved.
		...
		@param	format	The name of the image file format to use when saving
			...
			be used.
		@return	true if the required Dynamic_Image, image file pathname
			...
			is invalid.
		@see	invalidate()
		@see	save_image(Dynamic_Image*, const QString&, const QString&)
	*/
	bool image(Dynamic_Image* plastic_image,
			   const QString& pathname = QString(), const QString& format = QString());

	inline Dynamic_Image* image() const
	{
		return Image;
	}
	...
	/**	Invalidate any previous image save information.
		...
		@see	image(Dynamic_Image*, const QString&, const QString&)
	*/
	void invalidate();
	...
	*/
	/**	Display a save activity dialog and start the thread.
		...
		@see	image(Dynamic_Image*, const QString&, const QString&)
	*/
	bool save_image(Dynamic_Image* plastic_image = NULL,
					const QString& pathname = QString(), const QString& format = QString());
...
public slots:
	...
	/**	Cancel the thread's image save operation.
		...
		save_image(Dynamic_Image*, const QString&, const QString&) save_image}
