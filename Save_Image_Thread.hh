...
*/
class Save_Image_Thread : public QThread
{
  ...
  public:
    ...
    */
    bool image(Plastic_Image *plastic_image, const QString &pathname = QString(), const QString &format = QString());
    ...
    */
    /**	Display a save activity dialog and start the thread.
        ...
        @see	image(Plastic_Image*, const QString&, const QString&)
    */
    bool save_image(Plastic_Image *plastic_image = NULL, const QString &pathname = QString(),
  ...
  private:
    ...
    QString Pathname, Format;

    QDialog *Dialog;
    QHBoxLayout *Dialog_Layout;
    Activity_Indicator *Activity;
    QLabel *Format_Label, *Pathname_Label;

    QMessageBox *Message;

    mutable QMutex Sequence_Lock;
