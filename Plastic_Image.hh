...
*/
class Plastic_Image : public QImage
{
  public:
    /*==============================================================================
        Types
    ...
    */
    struct Triplet
    {
        ...
        */
        Triplet()
        {
            Datum[0] = Datum[1] = Datum[2] = UNDEFINED_PIXEL_VALUE;
        }
    ...
    struct Rendering_Monitor
    {
        ...
        */
        enum Status
        {
            ...
            RENDERED_DATA_MASK = (1 << 0) | (1 << 1),
            CANCELED = (1 << 2),
            DONE = (1 << 3),
            MAPPING_DATA = (1 << 4),
            REMAPPING_DATA = MAPPING_DATA | TOP_QUALITY_DATA
        };

        static const QString Status_Message[];
        ...
        */
        virtual bool notification(Plastic_Image &image, Status status, const QString &message,
                                  const QRect &display_region) = 0;
    ...
    */
    struct Render_Exception
    {
        ...
        explicit Render_Exception(const std::string &message) : Message(std::string(Plastic_Image::ID) + '\n' + message)
        {
        }
    ...
    */
    ...
    static bool Default_Auto_Update;

    //!	Default number of output image lines in each rendering increment.
    static unsigned int Default_Rendering_Increment_Lines;

    /*==============================================================================
        Constructors
    */
  protected:
    explicit Plastic_Image(const QSize &size, const unsigned int *band_map = NULL, const QTransform **transforms = NULL,
  ...
  public:
    ...
    */
    virtual Plastic_Image *clone(const QSize &size = QSize(), Mapping_Type shared_mappings = NO_MAPPINGS) const = 0;
  ...
  public:
    ...
    */
    ...
    /**	Get the value of a source image pixel datum.
        ...
        @return	A Pixel_Datum value. This will be the {@link
            ...
            invalid.
    */
    virtual Pixel_Datum source_pixel_value(unsigned int x, unsigned int y, unsigned int band) const = 0;
    ...
    */
    ...
    /**	Set the image band map.
        ...
        @see	source_band_map()
    */
    virtual bool source_band_map(const unsigned int *band_map, bool shared = false);
    ...
    */
    virtual bool set_source_transform(const QTransform &transform, int band = -1);
    ...
    */
    ...
    /**	Set the source-to-display geometric transformations for all bands.
        ...
        @see	source_transform_reset(int)
    */
    virtual bool source_transforms(const QTransform **transforms, bool shared = false);
    ...
    */
    bool source_scaling(double scale_horizontal, double scale_vertical, int band = -1);
    ...
    */
    void source_scaling(double *scale_horizontal, double *scale_vertical, int band = 0) const;
    ...
    */
    ...
    {
        return (Geo_Transforms &&
                (*Geo_Transforms[0] != *Geo_Transforms[1] || *Geo_Transforms[0] != *Geo_Transforms[2]))
                   ? TRANSFORMS
                   : IDENTICAL_MAPPINGS;
    }
    ...
    */
    ...
    {
        return (Data_Maps && (*Data_Maps[0] != *Data_Maps[1] || *Data_Maps[0] != *Data_Maps[2])) ? DATA_MAPS
                                                                                                 : IDENTICAL_MAPPINGS;
    }
    ...
    */
    ...
    {
        bool changed = Background_Color != color;
    ...
    */
    virtual unsigned long long source_histograms(QVector<Histogram *> histograms, const QRect &source_region) const;
    ...
    */
    virtual unsigned long long display_histograms(QVector<Histogram *> histograms, const QRect &display_region) const;
  ...
  protected:
    /**	Notify all {@link add_rendering_monitor(Rendering_Monitor*)
        ...
        @see	add_rendering_monitor(Rendering_Monitor*)
    */
    bool notify_rendering_monitors(Rendering_Monitor::Status status, const QString &message,
  ...
  public:
    ...
    */
    inline static void default_rendering_increment_lines(unsigned int rendering_increment)
    {
  ...
  protected:
    ...
    mutable idaeim::PVL::Aggregate *Image_Metadata;
    //!	Registered Metadata_Monitors.
    QList<Metadata_Monitor *> Metadata_Monitors;
    ...
    */
    ...
    struct Rendering_Data
    {
        ...
        QTransform **Geo_Transforms;
        Data_Map **Data_Maps;
        Mapping_Type Locally_Owned_and_Operated, Mapping_Differences;
        Mapping_Type Needs_Update;
        QRgb Background_Color;
    };
