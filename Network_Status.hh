...
class Network_Status
{
  ...
  protected:
    ...
    static unsigned long Default_Wait_Time;
  ...
  public:
    ...
    */
  protected:
    QUrl Requested_URL, Redirected_URL;
    int Request_Status, HTTP_Status;
    QString HTTP_Status_Description;

    unsigned long Wait_Time;

    //!	Thread-safe status values lock. N.B.: A recursive mutex is used.
    QRecursiveMutex *Status_Lock;
