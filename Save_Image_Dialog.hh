...
*/
class Save_Image_Dialog : public QFileDialog
{
  ...
  public:
    ...
    */
    ...
    static QString Default_Directory;

    //!	The default image file format.
    static QString Default_Image_Format;
    ...
    */
    /**	Construct a Save_Image_Dialog for the display of an Image_Viewer.
        ...
        @param	parent	The parent widget over which the dialog should be
            shown. May be NULL.
    */
    explicit Save_Image_Dialog(const Image_Viewer &image_viewer, QWidget *parent = NULL);
  ...
  private slots:
    ...
    */
  private:
    const Image_Viewer *Image_View;

    QString Pathname, Image_Format;

    QSizeF Displayed_Image_Size;

    QLabel *Thumbnail;
    QSpinBox *Image_Width, *Image_Height;
    QDoubleSpinBox *Image_Scale;
    QLabel *Max_Scale;
};
