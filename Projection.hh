...
class Projection
{
  public:
    ...
    */
    ...
    static const char *const IDENTITY_PROJECTION_NAME;
    ...
    static const bool DEFAULT_USE_SPHERICAL;
    ...
    */
    ...
    static const double DEFAULT_NA;
    ...
    */
    static Projection *create(const idaeim::PVL::Aggregate *parameters = 0, bool throw_on_failure = false);
  ...
  public:
    ...
    */
    static int is_requested(const char *const parameter_name, const char *const *required_list = NULL,
    ...
    */
    /**	Initialize the Projection parameters.
        ...
        @throws	idaeim::PVL::Out_of_Range	If a required parameter, or a
            ...
            invalid.
    */
    bool parameters(const idaeim::PVL::Aggregate *params = NULL, const char *const projection_ID = NULL);

    virtual double positive_meters(const idaeim::PVL::Aggregate &params, const char *const parameter) const;

    virtual double NA_checked(const idaeim::PVL::Aggregate &params, const char *const parameter) const;

    virtual QString string_value(const idaeim::PVL::Aggregate &params, const char *const parameter) const;
  ...
  protected:
    ...
    */
    ...
    static const double PI, PI_OVER_2, PI_OVER_180, PI_UNDER_180
#ifndef DBL_EPSILON
        ,
        DBL_EPSILON
#endif
