...
/*==============================================================================
    Constants
*/
const char *const Plastic_Image_Factory::ID =
...
/*==============================================================================
    Creators
*/
Plastic_Image *Plastic_Image_Factory::create(const QString &source_name, const QSize &size, QString *message)
{
    ...
    if (image)
        ...
        clog << "   unable to obtain source -" << endl << Error_Message << endl;
...
/*==============================================================================
    Helpers
*/
Plastic_QImage *Plastic_Image_Factory::create_Plastic_QImage(const QString &source_name, const QSize &size)
{
#if ((DEBUG_SECTION) & DEBUG_CONSTRUCTORS)
    clog << ">>> Plastic_Image_Factory::create_Plastic_QImage" << endl;
#endif
    Plastic_QImage *image = NULL;
...
#endif
            Error_Message += QObject::tr("An image could not be obtained from the file.");
        }
    }
#if ((DEBUG_SECTION) & DEBUG_CONSTRUCTORS)
    clog << "<<< Plastic_Image_Factory::create_Plastic_QImage" << endl;
...
JP2_Image *Plastic_Image_Factory::create_JP2_Image(const QString &source_name, const QSize &size)
{
#if ((DEBUG_SECTION) & DEBUG_CONSTRUCTORS)
    clog << ">>> Plastic_Image_Factory::create_JP2_Image" << endl;
#endif
    JP2_Reader *reader = NULL;
    JP2_Image *image = NULL;
#if ((DEBUG_SECTION) & DEBUG_LOAD_IMAGE)
    clog << "    constructing a JP2::reader on \"" << source_name.toStdString() << '"' << endl;
#endif
    try
    {
        reader = JP2::reader(source_name.toStdString());
    }
    ...
    {
#if ((DEBUG_SECTION) & DEBUG_LOAD_IMAGE)
        clog << "    JP2_Reader @ " << (void *)reader << endl << "    constructing a JP2_Image" << endl;
#endif
        //	N.B.: Ownership of the JP2_Reader is transferred.
        try
        {
            image = new JP2_Image(reader, size);
        }
        catch (JP2_Exception &except)
        {
            Error_Message += except.what();
...
/*==============================================================================
    Utilities
*/
bool Plastic_Image_Factory::is_file(const QString &pathname)
{
    bool OK = false;
...
/*==============================================================================
    Data
*/
QString Plastic_Image_Factory::Type, Plastic_Image_Factory::Error_Message;
