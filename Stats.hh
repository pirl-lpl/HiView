...
class Stats
{
  public:
    ...
    */
    ...
    {
        return Histograms[index_range_check(index)] ? Histograms[index]->size() : 0;
    }
  ...
  private:
    ...
    /*==============================================================================
        Data
    */
    int Values_Counted[3], Lowest_Value[3], Highest_Value[3], Lower_Limit, Upper_Limit;

    unsigned long long Minimum_Count[3], Maximum_Count[3], Valid_Area[3], Lower_Area[3], Upper_Area[3];

    double Mean_Value[3], Median_Value[3], Std_Dev_of_Values[3];
