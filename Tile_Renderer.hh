...
class Tile_Renderer : public QThread
{
    ...
    */
    ...
    explicit Tile_Renderer(QObject* parent = NULL);
    ...
    *//*
    ...
    friend class Tile_Rendering_Monitor;
    Tile_Rendering_Monitor
