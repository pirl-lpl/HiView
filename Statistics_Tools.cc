...
/*==============================================================================
    Constants
*/
const char *const Statistics_Tools::ID =
...
/*==============================================================================
    Constructor
*/
Statistics_Tools::Statistics_Tools(QWidget *parent) : QDockWidget(tr("Statistics"), parent), Visible_Graph(true)
{
...
#if ((DEBUG_SECTION) & (DEBUG_CONSTRUCTORS | DEBUG_LAYOUT))
    clog << "     Source_Statistics sizeHint = " << Source_Statistics->sizeHint() << endl;
#endif
    section = new QWidget;
...
#if ((DEBUG_SECTION) & (DEBUG_CONSTRUCTORS | DEBUG_LAYOUT))
    clog << "    Display_Statistics sizeHint = " << Display_Statistics->sizeHint() << endl;
#endif
    ...
    connect(Sections, SIGNAL(currentChanged(int)), SIGNAL(section_changed(int)));
...
#if ((DEBUG_SECTION) & (DEBUG_CONSTRUCTORS | DEBUG_LAYOUT))
    clog << "          adj tool Minimum_Size = " << Minimum_Size << endl << "<<< Statistics_Tools" << endl;
#endif
}
...
/*==============================================================================
    Accessors
*/
QSize Statistics_Tools::minimumSizeHint() const
{
...
QSize Statistics_Tools::sizeHint() const
{
#if ((DEBUG_SECTION) & DEBUG_LAYOUT)
...
/*==============================================================================
    Event Handlers
*/
void Statistics_Tools::resizeEvent(QResizeEvent *event)
{
#if ((DEBUG_SECTION) & DEBUG_EVENTS)
    clog << ">-< Statistics_Tools::resizeEvent: from " << event->oldSize() << " to " << event->size() << endl;
#endif
    Previous_Size = event->oldSize();
    QDockWidget::resizeEvent(event);
}

void Statistics_Tools::contextMenuEvent(QContextMenuEvent *event)
{
    //	>>> SIGNAL <<<
...
/*==============================================================================
    Manipulators
*/
bool Statistics_Tools::visible_graph(bool enabled)
{
#if ((DEBUG_SECTION) & DEBUG_LAYOUT)
    clog << ">>> Statistics_Tools::visible_graph: " << boolalpha << enabled << endl
         << "     Source_Statistics visible_graph = " << Source_Statistics->visible_graph() << endl
         << "    Display_Statistics visible_graph = " << Display_Statistics->visible_graph() << endl
...
/*==============================================================================
    Slots
*/
void Statistics_Tools::select_section(int index)
{
    Sections->setCurrentIndex(index);
}

void Statistics_Tools::select_section(QWidget *section)
{
