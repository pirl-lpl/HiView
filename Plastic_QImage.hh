...
namespace HiRISE
{
class Plastic_QImage : public Plastic_Image
{
  public:
    /*==============================================================================
        Constants
    ...
    */
    explicit Plastic_QImage(QImage *image = NULL, const QSize &size = QSize(), const unsigned int *band_map = NULL,
    ...
    /**	Construct a Plastic_QImage from a QImage.
        ...
        @param	data_maps	An array of data map arrays, one for each band
            ...
            default identity data maps will be provided.
    */
    explicit Plastic_QImage(const QImage &image, const QSize &size = QSize(), const unsigned int *band_map = NULL,
                            const QTransform **transforms = NULL, const Data_Map **data_maps = NULL);
    ...
    */
    explicit Plastic_QImage(const Plastic_QImage &image, const QSize &size = QSize(),
    ...
    */
    virtual Plastic_QImage *clone(const QSize &size = QSize(), Mapping_Type shared_mappings = NO_MAPPINGS) const;
