...
public:
    ...
    */
    ...
    /** Get the reference image.
        ...
        Dynamic_Image::Mapping_Type) cloned images}. <b>N.B.</b>: The
        ...
        @return A pointer to a Dynamic_Image that is the current reference
            image. This will never be NULL.
    */
    Dynamic_Image* reference_image() const;
    ...
    */
    ...
    /** Get a clone of the {@link reference_image() reference image.
        ...
        @param shared_mappings A Dynamic_Image::Mapping_Type bit map
            specifying the data mappings of the reference image to
            be shared with the clone. By default no data mappings are
            shared.
        @return A Dynamic_Image pointer to the image clone.
    */
    Dynamic_Image* image_clone(const QSize& size = QSize(0, 0),
                               Dynamic_Image::Mapping_Type shared_mappings = 0);
...
protected:
    ...
    /** Load any posted new source image.
        ...
        clone_image(Dynamic_Image*, const QSize&, Dynamic_Image::Mapping_Type)
        ...
        using the Renderer to {@link delete_image(Dynamic_Image*) queue the
    ...
    */
    ...
    /** Load an image from a named source.
        ...
        wrap it in a Dynamic_QImage. If the source can not be loaded an
        ...
        @return A pointer to a Dynamic_Image containing the image that was
            loaded. This will be NULL if an image could not be loaded from
            the source for any reason.
        @see load_image()
    */
    Dynamic_Image* load_image(const QString& source_name);
    ...
    */
    ...
    /** Clone an image.
        ...
        @param image A pointer to the Dynamic_Image to be cloned.
        ...
        @param shared_mappings A Dynamic_Image::Mapping_Type bit map
            ...
            be shared with the clone. By default no data mappings are
            shared.
        @return A Dynamic_Image pointer to the image clone. If no clone
            was created, either because the source image is NULL or an
            exception occured during cloning, NULL will be returned.
    */
    Dynamic_Image* clone_image(Dynamic_Image* image,
                               const QSize& size = QSize(0, 0),
                               Dynamic_Image::Mapping_Type shared_mappings = Dynamic_Image::NO_MAPPINGS);
...
public:
    ...
    /** Queue an image for rendering.
        ...
        start_rendering() started} if the rendering loop is {@link runnable()
        runnable}.

        <b>N.B.</b>: The queue is locked during the queuing operation.

        @param image A pointer to Dynamic_Image to be queued for rendering.
    ...
    */
    void queue(Dynamic_Image* image,
    ...
    /** Queue an image for rendering.
        ...
        @param cancelable If true the queued entry may be {@link cancel(bool)
            canceled; otherwise {@link clear()
        @see queue(Dynamic_Image*, const QPoint&, const QRect&, bool)
    */
    inline void queue(Dynamic_Image* image,
    ...
    */
    ...
    /** Test if an image is queued for rendering.
        ...
        <b>N.B.</b>: An image that {@link is_rendering(Dynamic_Image*) is
        rendering} is not in the rendering queue.

        If the image is NULL the test is if any image is queued.

        @param image A pointer to the Dynamic_Image to be sought in the
    ...
    */
    bool is_queued(Dynamic_Image* image = NULL) const;

    /** Test if an image is currently being rendered.

        If the image is NULL the test is if any image is being rendered.

        @param image A pointer to the Dynamic_Image to be compared with
    ...
    */
    bool is_rendering(Dynamic_Image* image = NULL) const;
    ...
    */
    bool will_delete(Dynamic_Image* image) const;
    ...
    */
    ...
    /** Cancel processing of an image.
        ...
        @param image A pointer to the Dynamic_Image to be removed from
    ...
    */
    bool cancel
    (Dynamic_Image* image, int cancel_options = WAIT_UNTIL_DONE);
    ...
    */
    ...
    /** Delete an image.
        ...
        abort(int) aborted}; {@link cancel(Dynamic_Image*, int) cancel}
        ...
        @param image A pointer to the Dynamic_Image object to be deleted.
    ...
    */
    bool delete_image(Dynamic_Image* image);
    ...
    /** Clean the queue of tiles pending deletion.
        ...
        @see delete_image(Dynamic_Image*)
...
protected:
    ...
    */
    ...
    /** Search a Tile_Queue for the Image_Tile containing a specific image.
        ...
        @param image A pointer to the Dynamic_Image that an Image_Tile
    ...
    */
    static int find_tile(Dynamic_Image* image, const Tile_Queue& queue);
    ...
    */
    ...
    /** Abort rendering.
        ...
        notified to {@link Dynamic_Image::cancel_update() cancel rendering}.
        ...
        not occur immediately: If rendering is in progress the Dynamic_Image
        ...
        deleted by the caller if the return value is false; any tile image
        queued for rendering should only be deleted after the image rendering
        has been successfully {@link cancel(Dynamic_Image*, bool) canceled},
        or the rendering loop is not active. This is best done by {@link
        delete_image(Dynamic_Image*) queueing the image for deletion} by the
...
public:
    ...
    */
    ...
    /** Suspend the rendering loop.
        ...
        queue(Dynamic_Image*, const QPoint&, bool) rendering queue} will
    ...
    */
    ...
    /** Stop the rendering loop.
        ...
        image is {@link queue(Dynamic_Image*, const QPoint&, bool) queued}
    ...
    */
    ...
    /** Test if the rendering loop is runnable when a source is registered
        ...
        registered or an image is {@link queue(Dynamic_Image*, const
...
protected:
    ...
    /** Load any pending new source image and render all queued image tiles.
        ...
        queue(Dynamic_Image*, const QPoint&, bool) queued as not cancelable}
    ...
    */
    ...
    /** Send the {@link rendered(const QPoint&, const QRect&) rendered signal}.
        ...
        Dynamic_Image::Rendering_Monitor::notification(Dynamic_Image&,
...
public:
    ...
    */
    ...
    /* Print a list of extant Dynamic_Images constructed by an Image_Renderer.

        <b>N.B.</b>: This method is a no-op unless the Image_Renderer class has
        been compiled with DEBUG defined.

        When an image is {@link clone_image(Dynamic_Image*, const QSize&,
        Dynamic_Image::Mapping_Type) cloned} it is appended to the
...
signals:
    ...
    */
    ...
    /** Signal tile image rendering progress.
        ...
        Dynamic_Image::Rendering_Monitor} when the Active_Tile does not
        ...
        Dynamic_Image::Rendering_Monitor::Status status} has an active
    ...
    */
    ...
    /** Signal the status of the renderer.
        ...
        rendering; check if any image {@link is_queued(Dynamic_Image*)
    ...
    */
    ...
    /** Signal an error condition.
        ...
        This signal is emitted from the main {@link render() render} loop
        to forward a {@link Dynamic_Image::Render_Exception} caught from
        ...
        This signal is emitted from the {@link clone_image(Dynamic_Image*,
        const QSize&, Dynamic_Image::Mapping_Type) image cloning} procedure
