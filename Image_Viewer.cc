...
)
{
    ...
    Dynamic_Image
        * plastic_image;
    if ((source = dynamic_cast<const Dynamic_Image*>(&source_image)))
    {
#if ((DEBUG_SECTION) & DEBUG_LOAD_IMAGE)
        OBJECT_CONDITIONAL(
            clog << "    cloning the Dynamic_Image" << endl;)
#endif
...
#if ((DEBUG_SECTION) & DEBUG_LOAD_IMAGE)
        OBJECT_CONDITIONAL(
            clog << "    wrapping the QImage in a Dynamic_Image" << endl;)
#endif
...
)
{
    ...
    if (display_position.x() < 0)
    {
        ...
        OBJECT_CONDITIONAL(
            ...
            << "    display_pixel = " << Dynamic_Image::Triplet() << endl
            << "      image_pixel = " << Dynamic_Image::Triplet() << endl;)
#endif
            emit image_pixel_value
            (Dynamic_Image::Triplet(), Dynamic_Image::Triplet());
    }
    else
    {
        // >>> SIGNAL <<
