...
/**	A <i>Image_Blaster</i> provides thread safe image rendering and
    deletion.

    An Image_Blaster manages a queue of images, encapsulated in image
    ...
    rendering loop to exit. For the Image_Blaster_Thread subclass,
...
class Image_Blaster : public QObject
{
 ...
 public:
    ...
    */
    enum : quint8
    {
        ...
        LOADING_IMAGE = RENDERING_LOW_PRIORITY | RENDERING_HIGH_PRIORITY,
        RENDERING_CANCELED = (1 << 2)
    };

    //!	Options when canceling rendering.
    static const int DO_NOT_WAIT, WAIT_UNTIL_DONE, DELETE_WHEN_DONE, FORCE_CANCEL;

    static const QPoint LOW_PRIORITY_RENDERING;

    static const bool CANCELABLE;
 ...
 protected:
    ...
    */
 public:
    explicit Image_Blaster(QObject* parent = nullptr);

    virtual ~Image_Blaster();

    /*==============================================================================
        Source image
    */
    /**	Load new source and reference images into this Image_Blaster.
 ...
 public:
    ...
    */
    ...
    /**	Cancel processing of an image.
        ...
        has been successfully canceled or this Image_Blaster is not running.
        ...
        @param	cancel_options	One or more cancel options bit flags. The
            ...
            this Image_Blaster is not, or no longer, processing the active
 ...
 protected:
    ...
    */
    ...
    /**	Add an Image_Tile to the Render_Queue.
        ...
        Finally, if this Image_Blaster is marked as {@link runnable()
    ...
    */
    ...
    /**	Clear the Render_Queue.
        ...
        @param	cancel_options	One or more cancel options bit flags. The
            ...
            active, tile remains this Image_Blaster is not, or no longer,
    ...
    */
    ...
    /**	Abort rendering.
        ...
        Image_Blaster_Thread implementation of this class) cancellation does
        ...
        Image_Blaster when it is not rendering.
    ...
    */
    ...
    /**	Delete all entries in the Delete_Queue.
        ...
        for use within the thread where this Image_Blaster is running; for
        any other thread access to the method would not be blocked while
        the Image_Blaster thread is manipulating the queue.
 ...
 public:
    ...
    */
    ...
    /**	Test if the rendering loop has been {@link suspend_rendering(bool)
        ...
        <b>N.B.</b>: A suspended Image_Blaster may still be in the processes
        of completing a rendering operation.

        @return	true if this Image_Blaster has been suspended; false
            otherwise.
        @see	suspend_rendering(bool)
    */
    ...
    /**	Stop the rendering loop.
        ...
        <b>N.B.</b>: If this Image_Blaster is an Image_Blaster_Thread -
    ...
    */
    ...
    /**	Test if the rendering loop is runnable when a source is registered
        ...
        A runnable Image_Blaster will be {@link start_rendering() started},
        ...
        QPoint&, bool) queued} for rendering. If the Image_Blaster is not
        runnable registering a source or queuing an image will not start
        rendering.

        @return	true if this Image_Blaster is runnable; false otherwise.
        @see	start_rendering()
        @see	stop_rendering(bool)
    */
    bool runnable() const;
 ...
 protected:
    ...
    */
    ...
    /**	Test if the rendering loop is to continue;
        ...
        This method is only used by a synchronous Image_Blaster; the
        Image_Blaster_Thread subclass overrides this method to provide
        thread blocking control.

        If this Image_Blaster is not runnable or is in the the process of
        finishing the {@link status(int) status} signal is emitted with the
        {@link #NOT_RENDERING} condition.

        @return true if this Image_Blaster is runnable and is not in the
 ...
 public:
    ...
    */
    ...
    /*	Print a list of extant Plastic_Images constructed by an Image_Blaster.

        <b>N.B.</b>: This method is a no-op unless the Image_Blaster class has
    ...
    */
    ...
    /**	Signal the status of the renderer.
        ...
        Image_Blaster_Thread::is_ready() asynchronous renderer} the signal
 ...
 private:
    ...
    */
    ...
    /*	Render only one image at a time.
        ...
        Because it is likely that there will be more than one Image_Blaster
        ...
        Image_Blaster objects. Therefor the rendering lock is a class data
