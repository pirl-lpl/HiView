...
namespace HiRISE
{
Distance_Line::Distance_Line(QWidget *parent) : QWidget(parent)
{
...
void Distance_Line::paintEvent(QPaintEvent *)
{
    ...
    int text_pos_x = (BottomRight_X - Dx / 2 - text_width - 2 < 0) ? BottomRight_X - Dx / 2 + 2
                                                                   : BottomRight_X - Dx / 2 - text_width - 2;
    int text_pos_y = (BottomRight_Y - Dy / 2 - text_height - 2 < 0) ? BottomRight_Y - Dy / 2 + text_height + 2
                                                                    : BottomRight_Y - Dy / 2 - 2;
