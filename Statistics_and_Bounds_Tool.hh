...
*/
class Statistics_and_Bounds_Tool : public Statistics_Tool
{
  ...
  public:
    ...
    */
    ...
    /*==============================================================================
        Constructors
    */
    Statistics_and_Bounds_Tool(const QString &title, QWidget *parent = NULL, Qt::WindowFlags flags = Qt::Widget);
  ...
  private:
    ...
    */
  private:
    QwtPlotMarker *Bound_Marker, *Lower_Limit_Marker, *Upper_Limit_Marker, *Upper_Bound_Marker[3],
        *Lower_Bound_Marker[3];

    int Lower_Bound_Value[3], Upper_Bound_Value[3];
    double Lower_Bound_Percent[3], Upper_Bound_Percent[3];
    int Selected_Bounds;
    bool Bounds_Moving;
