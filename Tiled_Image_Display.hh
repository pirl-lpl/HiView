      ...
      public Plastic_Image::Metadata_Monitor
{
 ...
 public:
    ...
    */
    ...
    enum : quint8
    {
        ...
        LOADING_IMAGE = RENDERING_BACKGROUND | RENDERING_VISIBLE_TILES,
 ...
 protected:
    ...
    static double Min_Scale, Max_Scale;
 ...
 private:
    ...
    */
    bool Pending_State_Change_Enabled;
    ...
    QSize Tile_Grid_Size;

    //!	Size of a tile in display space.
    QSize Tile_Display_Size;
