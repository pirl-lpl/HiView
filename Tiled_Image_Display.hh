...
/** A <i>Tiled_Image_Display</i> provides a QWidget for the display of
    a grid of image tiles rendered from a Dynamic_Image.

    The image displayed in the QWidget viewport is provided by rendering
    a grid of image tiles based on a single Dynamic_Image. In the
    degenerate case where the Dynamic_Image fully encapsulates a single,
    in-memory image (a Dynamic_QImage) a single tile the size of the
    ...
    Dynamic_Image::clone(const QSize&, Dynamic_Image::Mapping_Type)
    ...
    image, sharing the {@link Dynamic_Image::source_band_map() band map}
    and {@link Dynamic_Image::source_data_maps() data maps}, but having
    its own {@link Dynamic_Image::source_transforms() geometric
    ...
    pixels. Scaling is done by the Dynamic_Image class implementation
...
class Tiled_Image_Display
    ...
    public Dynamic_Image::Metadata_Monitor
{
    ...
    */
    ...
    typedef Dynamic_Image::Mapping_Type Mapping_Type;
    typedef Dynamic_Image::Data_Map Data_Map;
    typedef Dynamic_Image::Histogram Histogram;
    ...
    */
    ...
    /** Request that an image be loaded for display.
        ...
        @param source_image A pointer to a Dynamic_Image held in a
    ...
    */
    ...
    /** Get the source image for the currently displayed image.
        ...
        @return A Shared_Image reference counted pointer object holding
            the pointer to the Dynamic_Image used as the source image
            for the display.
    */
    ...
    */
    ...
    {
        return (int)Dynamic_Image::default_rendering_increment_lines();
    }

    void background_color(QRgb color);
    inline static QRgb background_color()
    {
        return Dynamic_Image::default_background_color();
    }
    ...
    */
    ...
    /** Get the image metadata.
        ...
        #Dynamic_Image::IMAGE_METADATA_GROUP} parameters with basic image
        ...
        metadata_changed(Dynamic_Image&) metadata changed} notification will
    ...
    */
    ...
    /** Receives notifications of changes to image metadata.
        ...
        the Dynamic_Image::Metadata_Monitor, of which a Tiled_Image_Display
        is a subclass. This Tiled_Image_Display object is expected to be
        {@link Dynamic_Image::add_metadata_monitor(Metadata_Monitor*)
        ...
        @param image A reference to the Dynamic_Image for which the
            metadata changed. This should be the {@link image() source
            image}.
    */
    virtual void metadata_changed(Dynamic_Image& image);
    ...
    */
    ...
    /** Get the image pixel datum at an image band coordinate.
        ...
        @param band The image band of the pixel datum, where zero is
            the reference band.
        @return The {@link #Dynamic_Image::Pixel_Datum} value at the
            specified image location. This will be the
            {@link #Dynamic_Image::UNDEFINED_PIXEL_VALUE} if the location
            is not within an active image tile or the image does not
            contain the specified band.
    */
    Dynamic_Image::Pixel_Datum image_pixel_datum
    ...
    /** Get the image pixel value at an image coordinate.
        ...
        @return A {@link #Dynamic_Image::Triplet} containing the three
            ...
            #Dynamic_Image::UNDEFINED_PIXEL_VALUE} if the mapping of the
            image coordinate for the corresponding band does not fall within
            an active image tile or the image does not contain the
            corresponding band.
    */
    Dynamic_Image::Triplet image_pixel(const QPoint& coordinate) const;
    ...
    */
    ...
    /** Get the display pixel value at a viewport display coordinate.
        ...
        @param coordinate A QPoint display viewport coordinate.
        @return A {@link #Dynamic_Image::Triplet} containing the three red,
            green blue {@link display_value(const QPoint&) display value}
            datum components at the display coordinate.
    */
    Dynamic_Image::Triplet display_pixel(const QPoint& coordinate) const;
    ...
    */
    ...
    /** Set the origin of the displayed tile grid in image space.
        ...
        Dynamic_Image::source_origin(const QPointF&, int) source origin}
    ...
    */
    ...
    /** Reset the location and scaling of the tiles.
        ...
        Dynamic_Image::source_band_map() band map} and {@link
        Dynamic_Image::source_data_maps() data maps} with the source image.
        ...
        results in the image {@link Dynamic_Image::needs_update() needing to
        be updated}, and image loading is not in progress, rendering of the
        image is {@link Image_Renderer::cancel(Dynamic_Image*, int)
        canceled}, without waiting, and then {@link
        Image_Renderer::queue(Dynamic_Image*, const QPoint&, const QRect&,
    ...
    */
    ...
    /** Set each tile image as needing the specified rendering update
        ...
        Dynamic_Image::needs_update(Mapping_Type) marked as needing the
