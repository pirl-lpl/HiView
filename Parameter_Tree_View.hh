...
*/
class Parameter_Tree_View : public QTreeView
{
  ...
  public:
    ...
    */
    ...
    static const bool DEFAULT_ANIMATION;
    ...
    */
    explicit Parameter_Tree_View(idaeim::PVL::Aggregate *parameters = NULL, QWidget *parent = NULL);
    ...
    */
    explicit Parameter_Tree_View(Parameter_Tree_Model *model, QWidget *parent = NULL);
  ...
  private:
    ...
    */
  private:
    Parameter_Tree_Model *Tree_Model;
    bool Tree_Model_Locally_Owned;
};
