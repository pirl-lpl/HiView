...
*/
class Parameter_Tree_Model : public QAbstractItemModel
{
  ...
  public:
    ...
    */
    ...
    static const char *const DEFAULT_ROOT_NAME;
    ...
    */
    /**	Constructs a Parameter_Tree_Model on an Aggregate.
        ...
        @param	parent	The parent QObject that will take ownership of
            the model.
    */
    explicit Parameter_Tree_Model(idaeim::PVL::Aggregate *root = NULL, QObject *parent = NULL);
    ...
    */
    virtual QModelIndex index(int row, int column, const QModelIndex &parent_index = QModelIndex()) const;
