...
/** An <i>Image_Tile</i> encapsulates a Dynamic_Image and the
...
public:
    ...
    */
    ...
    /** Construct an Image_Tile with a Dynamic_Image and optional
        rendering characteristics.

        @param image A pointer to a Dynamic_Image. This should not be
    ...
    */
    ...
    /** Delete the Image_Tile.
        ...
        If Delete_Image_When_Done is true the Dynamic_Image pointed to by
        Image is deleted.
    */
    ~Image_Tile();
