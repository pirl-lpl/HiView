 ...
 */
class Image_Viewer : public QFrame
{
 ...
 public:
    ...
    enum : quint8
    {
        ...
        RENDERING_VISIBLE_TILES = Tiled_Image_Display::RENDERING_VISIBLE_TILES,
        LOADING_IMAGE = Tiled_Image_Display::LOADING_IMAGE,
        RENDERING_CANCELED = Tiled_Image_Display::RENDERING_CANCELED
    };
    ...
    enum : quint16
    {
        ...
        DISPLAY_SIZE_STATE = Tiled_Image_Display::DISPLAY_SIZE_STATE,
        TILE_SIZE_STATE = Tiled_Image_Display::TILE_SIZE_STATE,
        IMAGE_MOVE_STATE = Tiled_Image_Display::IMAGE_MOVE_STATE,
        IMAGE_SCALE_STATE = Tiled_Image_Display::IMAGE_SCALE_STATE,
        BAND_MAPPING_STATE = Tiled_Image_Display::BAND_MAPPING_STATE,
        DATA_MAPPING_STATE = Tiled_Image_Display::DATA_MAPPING_STATE,
        STATE_TYPE_MASK = Tiled_Image_Display::STATE_TYPE_MASK,

        RENDERING_VISIBLE_TILES_STATE = Tiled_Image_Display::RENDERING_VISIBLE_TILES_STATE,
    ...
    static bool Default_Scaling_Immediate;
