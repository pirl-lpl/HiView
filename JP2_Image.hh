...
public:
    ...
    */
    ...
    /** Get the image metadata.
        ...
        requested. Then the base {@link Dynamic_Image::metadata() image metadata}
    ...
    */
    ...
    /** Set the source image to display image band mapping.
        ...
        If the {@link Dynamic_Image::source_band_map(const unsigned int*, bool)
    ...
    */
    ...
    {
        return Dynamic_Image::source_band_map();
    }
    ...
    /** Produce a histogram of source image data.
        ...
        Overrides the
        {@link Dynamic_Image::source_histograms(QVector<Histogram*>, const QRect&)
...
protected:
    ...
    /** Initialize the Source JP2_Reader and the pixel data buffers.
        ...
        The base Dynamic_Image class is first intialized.
    ...
    */
    ...
    /** Set or reset the rendering state.
        ...
        The base class {@link Dynamic_Image::is_rendering(bool)} method
        is called first.
    ...
    */
    ...
    {
        return Dynamic_Image::is_rendering();
    }
