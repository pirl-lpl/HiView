...
class JP2_Image : public Plastic_Image
{
  public:
    /*==============================================================================
        Types:
    ...
    */
    ...
    static Name_String JP2_METADATA_GROUP;
    ...
    */
    explicit JP2_Image(JP2_Reader *reader = NULL, const QSize &size = QSize(), const unsigned int *band_map = NULL,
                       const QTransform **transforms = NULL, const Data_Map **data_maps = NULL);
    ...
    /*	Construct a JP2_Image on a JP2_Reader.
        ...
        @param	data_maps	An array of data map arrays, one for each band of
            ...
            identity data maps will be provided.
    */
    explicit JP2_Image(const JP2_Reader &JP2_reader, const QSize &size = QSize(), const unsigned int *band_map = NULL,
                       const QTransform **transforms = NULL, const Data_Map **data_maps = NULL);
    ...
    */
    explicit JP2_Image(const JP2_Image &image, const QSize &size = QSize(), Mapping_Type shared_mappings = NO_MAPPINGS);
    ...
    */
    virtual JP2_Image *clone(const QSize &size = QSize(), Mapping_Type shared_mappings = NO_MAPPINGS) const;
    ...
    */
    ...
    virtual Pixel_Datum source_pixel_value(unsigned int x, unsigned int y, unsigned int band) const;
  ...
  private:
    ...
    */
    template <typename Pixel_Data_Type> bool map_source_data_to_display_data(const QRect &region = QRect());
    ...
    */
    ...
    void source_data_histogram(Histogram *histogram, const QRect &source_region, int band) const;

    /*==============================================================================
        Data
    */
  private:
    Shared_JP2_Reader Source;

    //	The asynchronous JP2_Reader::Rendering_Monitor event notifier.
    friend class JP2_Image_Rendering_Monitor;
    JP2_Image_Rendering_Monitor *Source_Rendering_Monitor;
    ...
    */
    Source_Data *Display_Data_Buffers[3];
    ...
    */
    ...
    Source_Data *Rendering_Data_Buffers[3], *Rendering_Display_Data_Buffers[3];

    //	Differential transformations from rendered source to display.
    QTransform Differential_Transforms[3];
