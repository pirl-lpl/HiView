...
*/
class Function_Nodes : public QwtSeriesStore<QPointF>
{
  public:
    /*==============================================================================
        Types
    ...
    */
    static void linear_interpolation(int x0, int y0, int x1, int y1, Data_Map *data_map);
    ...
    */
    ...
    {
        linear_interpolation(start.x(), start.y(), end.x(), end.y(), data_map);
    }
