...
/*==============================================================================
    Constants
*/
const char *const Help_Docs::ID = "UA::HiRISE::Help_Docs ($Revision: 1.10 $ $Date: 2013/09/24 19:05:42 $)";
...
/*==============================================================================
    Constructor
*/
Help_Docs::Help_Docs(const QString &docs_location) : Docs_Location_is_File(true)
{
...
/*==============================================================================
    Accessors
*/
bool Help_Docs::location(const QString &docs_location)
{
    ...
    else
    {
        ...
        {
            Docs_Location_is_File = (URL.scheme().compare("FILE", Qt::CaseInsensitive) == 0);
            ...
            clog << "    Docs_Location = " << Docs_Location << endl
                 << "    location is a " << (Docs_Location_is_File ? "file" : "URL") << endl;
#endif
        }
    }
#if ((DEBUG_SECTION) & DEBUG_ACCESSORS)
...
/*==============================================================================
    Manipulators
*/
bool Help_Docs::help(const QString &document)
{
    ...
    {
        QString location(Docs_Location);
...
/*==============================================================================
    Utility
*/
QString Help_Docs::find(const QString &document, const QStringList &locations)
{
...
#endif
    int index = -1, amount = locations.size();
    if (amount == 0)
...
bool Help_Docs::is_accessible(const QString &location)
{
    /*	MS/Windows gotcha:
