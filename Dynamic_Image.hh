...
HiROC CVS ID: $Id: Dynamic_Image.hh,v 2.33 2013/09/11 20:11:29 guym Exp $
...
namespace UA::HiRISE
{
/** A <i>Dynamic_Image</i> is a QImage that appears to be geometrically
    and photometrically plastic.

    Dynamic_Image is an abstract class that must be implemented by
    concrete classes that provide the image data source.

    Each subclass is expected to initialize the Dynamic_Image during
    construction.
...
public:
    ...
    */
    ...
    /** A <i>Triplet</i> holds pixel values for up to three bands.
        ...
        Dynamic_Image::source_pixel(const QPoint&) source image pixel value}.
    */
    struct Triplet
    {
    ...
    /** A <i>Metadata_Monitor</i> is a virtual interface used to monitor
        ...
        Dynamic_Image::add_metadata_monitor(Metadata_Monitor*) registered}
        with a Dynamic_Image to receive notifications whenever the {@link
    ...
    */
    struct Metadata_Monitor
    {
        ...
        @param image A reference to the Dynamic_Image for which its
            {@link Dynamic_Image::metadata() metadata} has changed.
        */
        virtual void metadata_changed(Dynamic_Image& image) = 0;
    ...
    /** A <i>Rendering_Monitor</i> is a virtual interface used to monitor
        ...
        implementation of this class may be {@link
        Dynamic_Image::add_rendering_monitor(Rendering_Monitor*) registered}
        with a Dynamic_Image to receive notifications of each image source
        rendering increment.
    */
    struct Rendering_Monitor
    {
        ...
        */
        ...
        /** Notification of rendering progress.
            ...
            <b>N.B.</b>: A Dynamic_Image may not implement incremental
            rendering, in which case notification will only occur when
            the rendering is done.

            @param image A reference to the Dynamic_Image that is doing
                the image rendering.
        ...
        */
        virtual bool notification(Dynamic_Image& image,
    ...
    */
    struct Render_Exception
    {
        ...
        explicit Render_Exception(const std::string& message)
            : Message(std::string(Dynamic_Image::ID) + '\n' + message)
        {}
    ...
    */
    ...
    //! Format used for all Dynamic_Image base QImage class objects.
    ...
    */
protected:
    explicit Dynamic_Image(const QSize& size,
...
private:
    Dynamic_Image() {};
    Dynamic_Image(const Dynamic_Image&) : QImage() {};
...
public:
    ...
    */
    /** Set the image source name.
        ...
        <b>N.B.</b>: If this Dynamic_Image has been {@link closed() closed}
        nothing is done.
    ...
    */
    ...
    /** Construct a clone of this Dynamic_Image.
        ...
        @return A pointer to a Dynamic_Image that is a copy of this image.
    */
    virtual Dynamic_Image* clone(const QSize& size = QSize(),
    ...
    */
    ...
    /** Add a Metadata_Monitor for this Dynamic_Image.
    ...
    */
    ...
    /** Remove a Metadata_Monitor for this Dynamic_Image.
...
public:
    ...
    /** Get the data source for this Dynamic_Image.
    ...
    */
    ...
    /** Reset the image band map to the default state.
        ...
        If this Dynamic_Image does not have a band map, neither locally
    ...
    */
    ...
    /** Produce histograms of source image data.
        ...
        source_band_map() mapped} into this Dynamic_Image. If a source data
    ...
    */
    ...
    /** Render the source image data into the destination display image.
        ...
        @return true if the source data was completely mapped; false if the
            ...
            Dynamic_Image implementation does incremental rendering and the
...
/** Set the needs update condition.
    ...
    N.B.: Normally a Dynamic_Image detects when its {@link
    ...
    Dynamic_Image sharing them can not detect when they have changed and
...
*/
    ...
    */
    ...
    /** Add a Rendering_Monitor for this Dynamic_Image.
    ...
    */
    ...
    /** Remove a Rendering_Monitor for this Dynamic_Image.
...
protected:
    /** Notify all {@link add_rendering_monitor(Rendering_Monitor*)
        ...
        @return true if rendering is to continue; false if rendering is to be
            ...
            Rendering_Monitor::notification(Dynamic_Image&, const QRect&)
...
public:
    ...
    */
    ...
    /** Set the suggested rendering increment.
        ...
        the Dynamic_Image implementation of how many lines of the display
...
protected:
    ...
    /** Initialize the object data structures.
        ...
        construction, the object data structures of the Dynamic_Image. Any
        data structures of the subclass may also be initialized at this time.

        When the Dynamic_Image is initialized the band map, source data maps
    ...
    */
    ...
    /** Set or reset the rendering state.
        ...
        copy of all the data members of this Dynamic_Image that are used in
        ...
        @param rendering true if rendering is starting and a copy of the
            Dynamic_Image rendering parameters (Rendering) is to be made;
    ...
    */
    ...
    /* Get a pointer to the image data.
        ...
        Dynamic_Image subclasses that are incrementally rendering or mapping
        source data.
...
protected:
    ...
    */
    ...
    // Data variables used in rendering copied from the Dynamic_Image.
    struct Rendering_Data
    {
        Rendering_Data(const Dynamic_Image& image);
...
void display_image_data(const Dynamic_Image& image);
void display_line_data(const Dynamic_Image& image, int line);
...
void mark_image(Dynamic_Image* image, const QString& label,
