...
*/
class Qstreambuf : public QObject, public std::streambuf
{
    Q_OBJECT
  ...
  protected:
    /**	Get data from the stream.
        ...
        @return	The number of characters transferred to the data buffer. This
            ...
            source.
    */
    virtual std::streamsize xsgetn(std::streambuf::char_type *data, std::streamsize amount);
    ...
    */
    virtual std::streambuf::pos_type seekoff(std::streambuf::off_type offset, std::ios_base::seekdir direction,
    ...
    */
    virtual std::streambuf::pos_type seekpos(std::streambuf::pos_type position, std::ios_base::openmode mode);
  ...
  public:
    ...
    */
    /**	Construct a Qistream on a QIODevice.
        ...
        @throws std::runtime_error if the QIODevice is not readable.
    */
    explicit Qistream(QIODevice *qiodevice) : std::istream(qstreambuf = new Qstreambuf(qiodevice))
    {
    }
